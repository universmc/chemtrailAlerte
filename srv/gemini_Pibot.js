...
const bot = new Telegraf('7458392614:AAHtMw4vexDqW6bxczx2UIZDR1i1F1CcfN4', {
    ...
    bot.start((ctx) => {
      ctx.reply('Bienvenue dans notre salon Telegram ChemtrailAlerte -app à l\'apprentissage automatique et à l\'intelligence artificielle Gémini_PiBot !');
    });
    ...
    console.log(`📶 Server chemtrailAlert running  📡  ✨.Gemini_Pibot. 🛰 `);
    bot.launch();