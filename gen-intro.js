...
async function main() {
  ...
  const chatCompletion = await groq.chat.completions.create({
    "messages": [
      ...
      {role: "assistant",name:"[📔_codex]", content:"[📔.codex]_Phase[02]: Créeatioon de l'application, Développement du système de mission, étape par étape suivant un modèle de Gantes. T'es Réponses devront être rédigé avec une approche métaphysique plan de développement à la langue française]"},
    ],
    model: "gemma2-9b-it",
    temperature: 0.6,
    max_tokens: 2048,
